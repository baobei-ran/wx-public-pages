...
<!-- 在线聊天室 -->
    <div class="index dis_f flex_d">
      ...
      <div class='chat-head-msg' v-if='is_daoBox'>医生将在<span>{{ daoTime }}</span>内回复你，超时未回复，将自动为您退诊</div>
      <div class='chat-head-msg' v-if="userMsg" ><span v-html='userMsg'></span> <span v-if='viewTime' style="margin-left: 15px;">{{viewTime}}</span></div>
        <div class='chat-head-msg' v-if="isbuyMsg">
        ...
        <div class="footer">
            <ul class="dis_f flex-vc">
              ...
              <li v-show="audioShow" class="contentTxt flex1 dis_f"><textarea class="flex1" @focus="animateWidth" ref='textMsg' v-model="textVal" ></textarea><i @click="handleIconShow" class="tb-icon"></i></li>
              <li class="btn">
